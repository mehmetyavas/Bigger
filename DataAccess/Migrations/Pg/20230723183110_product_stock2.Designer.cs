...
namespace DataAccess.Migrations.Pg
{
    ...
    [Migration("20230723183110_product_stock2")]
            ...
            modelBuilder.Entity("Core.Entities.Concrete.CartItem", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 21, 31, 10, 662, DateTimeKind.Local).AddTicks(5670));
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 21, 31, 10, 663, DateTimeKind.Local).AddTicks(230));
            ...
            modelBuilder.Entity("Core.Entities.Concrete.ProductImage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 21, 31, 10, 663, DateTimeKind.Local).AddTicks(1310));
