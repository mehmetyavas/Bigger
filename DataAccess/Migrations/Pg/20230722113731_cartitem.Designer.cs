...
namespace DataAccess.Migrations.Pg
{
    ...
    [Migration("20230722113731_cartitem")]
            ...
            modelBuilder.Entity("Core.Entities.Concrete.CartItem", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 7, 22, 14, 37, 31, 187, DateTimeKind.Local).AddTicks(6880));
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 7, 22, 14, 37, 31, 188, DateTimeKind.Local).AddTicks(9410));
            ...
            modelBuilder.Entity("Core.Entities.Concrete.ProductImage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 7, 22, 14, 37, 31, 189, DateTimeKind.Local).AddTicks(460));
