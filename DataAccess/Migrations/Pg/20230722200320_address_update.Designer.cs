...
namespace DataAccess.Migrations.Pg
{
    ...
    [Migration("20230722200320_address_update")]
            ...
            modelBuilder.Entity("Core.Entities.Concrete.CartItem", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 7, 22, 23, 3, 20, 66, DateTimeKind.Local).AddTicks(2500));
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 7, 22, 23, 3, 20, 66, DateTimeKind.Local).AddTicks(7050));
            ...
            modelBuilder.Entity("Core.Entities.Concrete.ProductImage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 7, 22, 23, 3, 20, 66, DateTimeKind.Local).AddTicks(8100));
