...
namespace DataAccess.Migrations.Pg
{
    ...
    [Migration("20230723175924_product_stock")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Cart", b =>
                {
                    b.Property<int>("Id")
            ...
            modelBuilder.Entity("Core.Entities.Concrete.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 20, 59, 24, 216, DateTimeKind.Local).AddTicks(4630));
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 20, 59, 24, 216, DateTimeKind.Local).AddTicks(9450));
            ...
            modelBuilder.Entity("Core.Entities.Concrete.ProductImage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 7, 23, 20, 59, 24, 217, DateTimeKind.Local).AddTicks(570));
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Cart", b =>
                {
                    b.HasOne("Core.Entities.Concrete.User", "User")
                        .WithOne("Cart")
                        .HasForeignKey("Core.Entities.Concrete.Cart", "Id")
            ...
            modelBuilder.Entity("Core.Entities.Concrete.CartItem", b =>
                {
                    b.HasOne("Core.Entities.Concrete.Cart", "Cart")
                        .WithMany("CartItem")
